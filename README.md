...
- Strengthening **Python + SQL** workflows for data cleaning, querying, and analysis.
- Practicing **exploratory data analysis** with Jupyter Notebook, Pandas, NumPy, Excel, and Power BI.
- Learning **data science and machine learning fundamentals**, including model training concepts and evaluation basics.
- Improving my database and backend foundations because strong analysis depends on reliable data systems.
...
My next goal is to convert learning into stronger data-focused portfolio evidence:
...
- A beginner machine learning notebook covering data preparation, training, evaluation, and interpretation.
